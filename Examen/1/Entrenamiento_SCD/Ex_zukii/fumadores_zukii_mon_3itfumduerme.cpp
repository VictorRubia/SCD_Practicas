...
class Estanco : public HoareMonitor{
   private:
      ...
      int ingrediente, num_veces_fum[num_fumadores], num_veces_ingr[num_fumadores];
   public:
      Estanco(){
         ingrediente=-1;
      ...
      void obtenerIngredienteFumador(int num_fumador){
         if(num_fumador==ingrediente){
            mostrador.signal();
            num_veces_fum[num_fumador]++;
            ingrediente=-1;
            if(num_veces_fum[num_fumador] == 2)
               dormir(num_fumador);
            else
      ...
      void ponerIngredienteMostrador(int ingr){
         ...
         if(num_veces_ingr[ingr] == 3){
            mtx.lock();
            cout << "Fumador " << ingr << " despierta!!!" << endl;
            mtx.unlock();
            num_veces_ingr[ingr] = 0;
