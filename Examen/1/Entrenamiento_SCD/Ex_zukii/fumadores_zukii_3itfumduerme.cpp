...
Semaphore dormido=0;
vector<int> ingredientes_puestos = {0, 0, 0} ;
...
void funcion_hebra_estanquero(  )
{
   ...
   while(true){
      ...
      ingredientes_puestos[num_fumador]++;
      
      cout << "Se ha puesto el ingrediente número: " << num_fumador << endl;

      if(ingredientes_puestos[num_fumador] == 4){
         ingredientes_puestos[num_fumador] = 0;
         cout << "Fumador " << num_fumador << " se despierta." << endl;
         sem_signal(dormido);
      }
...
void  funcion_hebra_fumador( int num_fumador )
{
   ...
   while( true )
   {
      ...
      if(varlocal == 3){
         varlocal = 0;
         cout << "Fumador " << num_fumador << " se duerme" << endl;
         sem_wait(dormido);
      }
      fumar(num_fumador);
